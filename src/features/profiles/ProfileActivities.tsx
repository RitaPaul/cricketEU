...
import Meeting from '../../assets/categoryImages/Meeting.jpg';
import Other from '../../assets/categoryImages/Other.jpg';
import Match from '../../assets/categoryImages/Match.jpg';
        ...
        <Grid.Column width={16}>
          ...
          <Card.Group itemsPerRow={4}>
            {userActivities.map((activity: IUserActivity) => (
              ...
              >
                <Image
                  src={imageUrlFinder(activity.title)}
